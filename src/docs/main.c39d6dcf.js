...
function (_Phaser$Scene) {
  ...
  _createClass(PlayScene, [{
    ...
    value: function create() {
      ...
      this.physics.add.collider(this.player, this.enemy); // this.physics.add.collider(this.player, this.block)
      ...
      this.Keyboard = this.input.keyboard.addKeys("W, A, S, D, B, P, F"); // bait group
    ...
    value: function update(time, delta) {
      ...
      this.physics.add.overlap(this.player, this.block); // if(this.physics.world.collide(this.player, this.block) && this.Keyboard.D.isDown && this.Keyboard.F.isDown) {
      //   console.log("X120")
      //   this.block.setVelocityX(120)
      // }
